...
/*
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    _______,  _______,  KC_1, KC_2, KC_3,  KC_BSLS,,  KC_MUTE,   _______,  _______,  _______,  _______,  _______,  _______,  _______,
                                  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______
 ),

    [_SYM] = LAYOUT_polydactyl(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
              KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_RBRC,                       _______,  _______,  _______,  _______,  _______,
    _______,  KC_DLR, KC_PERC, KC_CIRC, KC_BSLS, KC_GRV,                       _______,  _______,  _______,  _______,  _______,  _______,
    _______,  KC_EXLM, KC_AT, KC_HASH,  KC_PIPE,  KC_TILD,  KC_MUTE,   _______,  _______,  _______,  _______,  _______,  _______,  _______,
                                  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______
 ),
