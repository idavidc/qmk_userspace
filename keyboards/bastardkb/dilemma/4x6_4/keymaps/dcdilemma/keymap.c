...
void x_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (xtap_state.state) {
        ...
        case TD_SINGLE_HOLD: register_code16(RCTL(X_HOME)); break;
        case TD_DOUBLE_TAP: register_code(RCTL(X_HOME)); break;
...
void x_reset(tap_dance_state_t *state, void *user_data) {
    switch (xtap_state.state) {
        ...
        case TD_SINGLE_HOLD: unregister_code16(RCTL(X_HOME)); break;
